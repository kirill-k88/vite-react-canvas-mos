import {
  ...
  INTERNAL_TEXT_BACKGROUND,
  INTERNAL_TEXT_BORDER_COLOR,
  INTERNAL_TEXT_BORDER_RADIUS,
  INTERNAL_TEXT_BORDER_WIDTH,
  INTERNAL_TEXT_COLOR,
  INTERNAL_TEXT_FONT,
...
export const getJobTextParams = () => {
  ...
  const jobTexts = DATA.map((job, i) => {
    ...
    return {
      ...
      backgroundColor: INTERNAL_TEXT_BACKGROUND,
      borderWidth: INTERNAL_TEXT_BORDER_WIDTH,
      borderColor: INTERNAL_TEXT_BORDER_COLOR,
      borderRadius: INTERNAL_TEXT_BORDER_RADIUS
    };
  });
